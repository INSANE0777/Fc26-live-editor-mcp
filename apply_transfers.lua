...
local TRANSFERS = {
    { name = "Bruno Guimarães", to = "Arsenal", pid = 247851, tid = 1, kind = 'perm', contractEndYear = 2030, joinSerial = 162100 },
    { name = "Franco Mastantuono", to = "Fiorentina", pid = 279173, tid = 110374, kind = 'loan', loanParent = 243, loanEndSerial = 162426, loanBuy = 0 },
    { name = "Djibril Sow", to = "Genoa", pid = 229752, tid = 110556, kind = 'perm', contractEndYear = 2030, joinSerial = 162099 },
    { name = "Maghnes Akliouche", to = "Paris Saint-Germain", pid = 264862, tid = 73, kind = 'perm', contractEndYear = 2030, joinSerial = 162099 },
    { name = "James Trafford", to = "Leeds United", pid = 263063, tid = 8, kind = 'perm', contractEndYear = 2030, joinSerial = 162099 },
    { name = "Konstantinos Tzolakis", to = "Hull City", pid = 252552, tid = 1952, kind = 'perm', contractEndYear = 2030, joinSerial = 162097 },
    { name = "Miguel Gutiérrez", to = "Bayer Leverkusen", pid = 261865, tid = 32, kind = 'perm', contractEndYear = 2030, joinSerial = 162097 },
    { name = "Florentino", to = "Ipswich Town", pid = 234569, tid = 94, kind = 'perm', contractEndYear = 2030, joinSerial = 162096 },
    { name = "Gonzalo García", to = "Fulham", pid = 278399, tid = 144, kind = 'perm', contractEndYear = 2030, joinSerial = 162095 },
    { name = "Konstantinos Karetsas", to = "Borussia Dortmund", pid = 70497, tid = 22, kind = 'perm', contractEndYear = 2030, joinSerial = 162095 },
    { name = "Valentín Barco", to = "Chelsea", pid = 263370, tid = 5, kind = 'perm', contractEndYear = 2030, joinSerial = 162094 },
    { name = "Kerim Alajbegovic", to = "Juventus", pid = 75533, tid = 45, kind = 'perm', contractEndYear = 2030, joinSerial = 162094 },
    { name = "Konstantinos Koulierakis", to = "Roma", pid = 270077, tid = 52, kind = 'perm', contractEndYear = 2030, joinSerial = 162093 },
    { name = "Mamadou Sangaré", to = "Brentford", pid = 258601, tid = 1925, kind = 'perm', contractEndYear = 2030, joinSerial = 162093 },
    { name = "António Silva", to = "AFC Bournemouth", pid = 270086, tid = 1943, kind = 'perm', contractEndYear = 2030, joinSerial = 162093 },
    { name = "Carlos Espí", to = "Real Madrid", pid = 70967, tid = 243, kind = 'perm', contractEndYear = 2030, joinSerial = 162091 },
    { name = "Artem Dovbyk", to = "Bologna", pid = 242458, tid = 189, kind = 'loan', loanParent = 52, loanEndSerial = 162426, loanBuy = 0 },
    { name = "Santiago Castro", to = "Roma", pid = 267861, tid = 52, kind = 'perm', contractEndYear = 2030, joinSerial = 162091 },
    { name = "Matthis Abline", to = "Monaco", pid = 264422, tid = 69, kind = 'perm', contractEndYear = 2030, joinSerial = 162091 },
    ...
    { name = "Crysencio Summerville", to = "Al Hilal", pid = 251954, tid = 605, kind = 'perm', contractEndYear = 2030, joinSerial = 162085 },
    { name = "Aladji Bamba", to = "Newcastle United", pid = 75734, tid = 13, kind = 'perm', contractEndYear = 2030, joinSerial = 162085 },
    { name = "Alejandro Garnacho", to = "Aston Villa", pid = 268438, tid = 2, kind = 'loan', loanParent = 5, loanEndSerial = 162426, loanBuy = 0 },
    { name = "Christos Tzolis", to = "Arsenal", pid = 256948, tid = 1, kind = 'perm', contractEndYear = 2030, joinSerial = 162084 },
    { name = "Karim Adeyemi", to = "Barcelona", pid = 251852, tid = 241, kind = 'perm', contractEndYear = 2030, joinSerial = 162084 },
    { name = "Ibrahima Ba", to = "Sporting CP", pid = 71781, tid = 237, kind = 'perm', contractEndYear = 2030, joinSerial = 162083 },
    { name = "Morgan Rogers", to = "Chelsea", pid = 260247, tid = 5, kind = 'perm', contractEndYear = 2030, joinSerial = 162083 },
    { name = "Abdul Fatawu", to = "Ipswich Town", pid = 267680, tid = 94, kind = 'perm', contractEndYear = 2030, joinSerial = 162083 },
    { name = "João Gomes", to = "Aston Villa", pid = 273463, tid = 2, kind = 'perm', contractEndYear = 2030, joinSerial = 162081 },
    { name = "Christ Inao Oulaï", to = "Fiorentina", pid = 74735, tid = 110374, kind = 'perm', contractEndYear = 2030, joinSerial = 162081 },
    { name = "Trincão", to = "Al Ahli", pid = 244778, tid = 112387, kind = 'perm', contractEndYear = 2030, joinSerial = 162079 },
    { name = "Johan Manzambi", to = "Aston Villa", pid = 276694, tid = 2, kind = 'perm', contractEndYear = 2030, joinSerial = 162078 },
    { name = "Robin Gosens", to = "Schalke 04", pid = 223697, tid = 34, kind = 'loan', loanParent = 110374, loanEndSerial = 162426, loanBuy = 0 },
    { name = "Maxime Estève", to = "RB Leipzig", pid = 262042, tid = 112172, kind = 'perm', contractEndYear = 2030, joinSerial = 162078 },
    { name = "Zeki Çelik", to = "Juventus", pid = 224490, tid = 45, kind = 'perm', contractEndYear = 2030, joinSerial = 162077 },
    { name = "Lesley Ugochukwu", to = "Galatasaray", pid = 257084, tid = 325, kind = 'loan', loanParent = 1796, loanEndSerial = 162426, loanBuy = 1 },
    { name = "Youri Tielemans", to = "Manchester United", pid = 216393, tid = 11, kind = 'perm', contractEndYear = 2030, joinSerial = 162075 },
    { name = "Leandro Trossard", to = "Beşiktaş", pid = 207421, tid = 327, kind = 'perm', contractEndYear = 2029, joinSerial = 162075 },
